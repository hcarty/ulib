...
(* OASIS_START *)
(* DO NOT EDIT (digest: 20fd2b99e8fd5f3c58c9c9f21a8836b0) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          license_file = Some "LICENSE.in";
          copyrights = [];
          maintainers = [];
          authors = ["Francois Clement"; "Pierre Weis"; "et al."];
          homepage = None;
          synopsis = "Standard library extensions from the OCaml CVS tree";
          description = None;
          categories = [];
                   ...
                   },
                   {
                      lib_modules =
                        [
                           "Uaref";
                           "Uarray";
                           "Uarray1_with_c_layout";
                           "Uarray1_with_fortran_layout";
                           "Uarray2_with_c_layout";
                           "Uarray2_with_fortran_layout";
                           "Ubuffer";
                           "Ucommand_option";
                           "Ulist1";
                           "Ulist";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\225\215\t\183\233l\167u\240\019o\028\001\004!\168";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
